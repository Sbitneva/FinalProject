...
public final class RegistrationService {
    ...
    private static final String CHECK_EMAIL_REGEXP =
            "(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|\""
            ...
            + "[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])+)\\])";
    private static final String CHECK_USERNAME_REGEXP =
            "[\\p{Alpha}\\-]{3,}";
     ...
     * @return User ID
     * @throws RegistrationException Input data validation failed
     */
    public int register(final String firstName, final String lastName, final String email, final String password)
    ...
    private boolean verifyEmail(final String email) throws RegistrationException {
    ...
    private boolean verifyName(final String name) throws RegistrationException {
        boolean result = false;
